"""IPA -> 汉字音译 (中文拟音) generation.

Extracted from scripts/gen_transliteration.py so the pipeline can generate
transliterations at merge time; the script imports from here (single source
of truth for the mapping tables).
"""
